        ...
        child: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: const [
                Text('계정 만들기', style: StyledFont.LARGE_TITLE),
                SizedBox(height: 16),
                EmailForm(),
...
class EmailForm extends GetView<SignupController> {
...
class VerificationCodeForm extends GetView<SignupController> {
...
class PasswordForm extends GetView<SignupController> {
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => controller.isEmailVerified.isTrue
          ? InputTextFormField(
              autofocus: controller.isEmailVerified.isTrue,
...
class ConfirmPasswordForm extends GetView<SignupController> {
...
class SubmitButton extends GetView<SignupController> {
